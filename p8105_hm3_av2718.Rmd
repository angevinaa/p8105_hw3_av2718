...
As expected, we can observe from the most commonly observed value of `snow` is 0, which makes sense since in New York it doesn't snow most of the year.
...
**Step 4:**  Below we make a two-panel plot showing `tmax` vs `tmin` for the full dataset: 
